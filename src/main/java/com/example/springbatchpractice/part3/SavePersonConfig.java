...
public class SavePersonConfig {
    ...
    private ItemWriter<Person> itemWriter() throws Exception {
        JpaItemWriter<Person> jpaItemWriter = new JpaItemWriterBuilder<Person>()
                ...
                .build();
        ItemWriter<Person> logItemWriter = items -> log.info("size: {}", items.size());
    ...
    private ItemReader<Person> itemReader() throws Exception {
        ...
        FlatFileItemReader<Person> itemReader = new FlatFileItemReaderBuilder<Person>().name("savePersonItemReader")
                .encoding("UTF-8")
                .linesToSkip(1)
